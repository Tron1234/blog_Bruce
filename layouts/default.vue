  ...
  <div class="flex justify-center min-h-screen">
    <div class="flex flex-col container" :class="bg200">
      ...
      <footer class="
          ...
          whitespace-nowrap
        " :class="bg200">
        <a class="hidden sm:block text-xl font-bold text-gray-800 hover:text-gray-700 cursor-pointer" @click="openContactDialog">contact</a>
        ...
        <div class="hidden sm:flex -mx-2">
          <a :href="getUserInfo.github" class="mx-2 text-gray-600 hover:text-gray-500" aria-label="Github">
            <svg class="w-7 h-7 fill-current" viewBox="0 0 24 24" fill="#000" xmlns="http://www.w3.org/2000/svg">
          ...
          <a :href="getUserInfo.twitter" class="mx-2 text-gray-600 hover:text-gray-500" aria-label="Twitter">
            <svg class="w-7 h-7 fill-current" viewBox="0 0 1024 1024" fill="#000" xmlns="http://www.w3.org/2000/svg">
